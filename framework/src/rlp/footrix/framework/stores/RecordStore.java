...
public interface RecordStore {
    ...
    record Create(RecordStore store) {
        ...
        public PlayerMatchRecord playerMatchRecord(String matchId, String player, String team, String competition, int season, Instant date, Integer enterMinute, Integer exitMinute, int maxMinutes, Double score, boolean injured, boolean expelled, int goals, int assists, int receivedGoals, int yellowCards, int redCards, double preEnergy) {
            PlayerMatchRecord analysis = new PlayerMatchRecord(matchId, player, team, competition, season, date, enterMinute, exitMinute, maxMinutes, score, injured, expelled, goals, assists, receivedGoals, yellowCards, redCards, preEnergy);
