...
public record MatchDefinition(String local, String visitant, String competition, int season, int phase, int group, String matchDay) {
    ...
    public static MatchDefinition of(String matchId) {
        String[] tokens = matchId.split(Separator);
    ...
    public String id() {
        return competition + Separator + phase + Separator + group + Separator + season + Separator + local + Separator + visitant + Separator + matchDay;
    }
}
