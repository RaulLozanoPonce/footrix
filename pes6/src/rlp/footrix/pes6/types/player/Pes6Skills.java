package rlp.footrix.pes6.types.player;

import rlp.footrix.framework.types.entities.player.Player;
import rlp.footrix.framework.types.entities.player.Position;
import rlp.footrix.framework.types.entities.player.facets.SkillsFacet;
import rlp.footrix.pes6.calculators.OverallCalculator;
import rlp.footrix.pes6.types.Pes6Player;

import java.time.Instant;

import static rlp.footrix.pes6.calculators.SkillCalculator.*;

public class Pes6Skills implements SkillsFacet {
    private final Pes6Player player;
