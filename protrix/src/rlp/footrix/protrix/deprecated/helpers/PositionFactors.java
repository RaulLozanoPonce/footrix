//package rlp.footrix.protrix.deprecated.helpers;
//
...
//    //foulsReceivedOf, yellowCardOf, redCardOf, yellowExpulsions
//    private static final Map<Position, Double[]> points = new HashMap<>() {{
//            put(Position.PT, new Double[] {0.5, -1.0, 2.0, -0.5, 0.1, -0.2, 1.5, 0.0, 1.0, 3.0, 10.0, 5.0, -0.5, 0.2, -2.0, -5.0, -5.0, -3.0, 1.5});
//            put(Position.CT, new Double[] {1.0, -0.5, 2.0, -1.0, 0.1, -0.2, 1.5, 0.0, 0.5, 1.5, 5.0, 3.0, -0.5, 0.2, -2.0, -5.0, -4.0, -1.5, null});
//            put(Position.CAR, new Double[] {1.5, -0.5, 2.0, -1.0, 0.1, -0.2, 1.5, 0.0, 1.0, 2.0, 6.0, 4.0, -0.5, 0.3, -2.0, -5.0, -4.0, -1.0, null});
//            put(Position.LAT, new Double[] {1.5, -0.5, 2.0, -1.0, 0.2, -0.3, 1.5, 0.0, 1.0, 2.0, 6.0, 4.0, -0.5, 0.3, -2.0, -5.0, -4.0, -1.0, null});
//            put(Position.CCD, new Double[] {1.0, -0.5, 2.0, -1.0, 0.1, -0.2, 1.5, 0.0, 1.0, 2.0, 5.0, 3.0, -0.5, 0.3, -2.0, -5.0, -4.0, -0.5, null});
//            put(Position.CC, new Double[] {1.5, -0.5, 1.5, -0.5, 0.2, -0.2, 1.0, 0.0, 1.0, 2.0, 5.0, 4.0, -0.5, 0.3, -2.0, -5.0, -4.0, -0.3, null});
//            put(Position.MP, new Double[] {2.0, -0.5, 1.0, -0.5, 0.3, -0.3, 1.0, 0.0, 1.0, 2.5, 6.0, 5.0, -0.5, 0.4, -2.0, -5.0, -4.0, -0.2, null});
//            put(Position.VOL, new Double[] {1.5, -0.5, 2.0, -0.5, 0.2, -0.3, 1.5, 0.0, 1.0, 2.0, 5.0, 4.0, -0.5, 0.3, -2.0, -5.0, -4.0, -0.7, null});
//            put(Position.EXT, new Double[] {2.0, -0.5, 1.0, -0.5, 0.3, -0.3, 1.0, 0.0, 1.0, 2.5, 6.0, 5.0, -0.5, 0.4, -2.0, -5.0, -4.0, -0.2, null});
//            put(Position.SS, new Double[] {2.0, -0.5, 1.0, -0.5, 0.4, -0.3, 1.0, 0.0, 1.5, 2.5, 7.0, 6.0, -0.5, 0.5, -2.0, -5.0, -4.0, -0.3, null});
//            put(Position.DL, new Double[] {2.0, -0.5, 0.5, -0.2, 0.4, -0.3, 0.5, 0.0, 1.5, 2.5, 8.0, 6.0, -0.5, 0.5, -2.0, -5.0, -4.0, -0.1, null});
//    }};
//
...
//    }
//
//    public static Double shootInTargetSavedOf(Position position) {
...
//    }
//
//    public static Double yellowExpulsionOf(Position position) {
//        return points.get(position)[16];
//    }
//
//    public static Double goalReceivedOf(Position position) {
//        return points.get(position)[17];
//    }
//
//    public static Double saves(Position position) {
//        return points.get(position)[18];
//    }
//
