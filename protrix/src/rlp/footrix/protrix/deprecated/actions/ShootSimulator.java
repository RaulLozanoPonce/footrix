...
//import static rlp.footrix.framework.types.entities.player.Position.PT;
//
...
//        state.addGoal(player, goalKeeper, rivalTeam);
//        boolean hasAssistance = state.previousPlayerWithPossession() != null;
//        if (hasAssistance) {
//            state.addAssistance(state.previousPlayerWithPossession());
//            events.add(new Match.MatchEvent(team, Goal, minute, state.playerWithPossession().definition().id(), state.previousPlayerWithPossession().definition().id(), null));
//        } else {
//            events.add(new Match.MatchEvent(team, Goal, minute, state.playerWithPossession().definition().id(), null, null));
//        }
//        return events;
//    }
//
