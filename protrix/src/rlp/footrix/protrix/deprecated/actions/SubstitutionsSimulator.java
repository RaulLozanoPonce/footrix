...
//                .filter(e -> e.type() == Substitution && e.metaInfo() != null)
...
//            events.add(new Match.MatchEvent(team, Substitution, minute, successful.definition().id(), playerToSubstitute.definition().id(), null));
//            if (necessarySubstitutions.contains(playerId)) events.add(new Match.MatchEvent(team, Substitution, minute, playerToSubstitute.definition().id(), null, new JsonObject()));
//        }
//        return events;
//    }
//
