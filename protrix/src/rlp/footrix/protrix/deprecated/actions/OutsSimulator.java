...
//            events.add(new Match.MatchEvent(team, Expulsion, minute, player, null, null));
...
//                events.add(new Match.MatchEvent(team, Substitution, minute, worstPlayer.definition().id(), null, metadata));
//            }
