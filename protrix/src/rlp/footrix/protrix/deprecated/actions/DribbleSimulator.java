//package rlp.footrix.protrix.deprecated.actions;
//
...
//import rlp.footrix.protrix.deprecated.MatchState;
//import rlp.footrix.protrix.deprecated.helpers.PositionFactors;
//
...
//            events.add(new Match.MatchEvent(rivalTeam, YellowCard, minute, rival.definition().id(), null, null));
//        } else if (cardRandom < 0.39 + 0.013) {
//            state.addRedCard(rival);
//            events.add(new Match.MatchEvent(rivalTeam, RedCard, minute, rival.definition().id(), null, null));
//        }
//    }
//
...
//        events.add(new Match.MatchEvent(team, Injury, minute, player.definition().id(), null, null));
//        events.add(new Match.MatchEvent(team, Substitution, minute, player.definition().id(), null, new JsonObject()));
