...
//import java.util.*;
//
//import static rlp.footrix.protrix.deprecated.helpers.PositionFactors.*;
//
...
//        playerStatisticsOf(dribbler.definition().id()).addScore(unsuccessfulDribbleCutOf(positionOf(haggled)));
//        VarTerminal.publish(new SuccessfulDribbleRevision(positionOf(dribbler).name()));
//        VarTerminal.publish(new UnsuccessfulDribbleCutRevision(positionOf(haggled).name()));
//    }
//
...
//        playerStatisticsOf(dribbler.definition().id()).addScore(successfulDribbleCutOf(positionOf(haggled)));
//        VarTerminal.publish(new UnsuccessfulDribbleRevision(positionOf(dribbler).name()));
//        VarTerminal.publish(new SuccessfulDribbleCutRevision(positionOf(dribbler).name()));
//    }
//
...
//        if (cutter != null) {
//            playerStatisticsOf(passer.definition().id()).addScore(unsuccessfulPassCutOf(positionOf(cutter)));
//            VarTerminal.publish(new UnsuccessfulPassCutRevision(positionOf(cutter).name()));
//        }
//    }
//
...
//        playerStatisticsOf(passer.definition().id()).addScore(successfulPassCutOf(positionOf(cutter)));
//        VarTerminal.publish(new UnsuccessfulPassRevision(positionOf(passer).name()));
//        VarTerminal.publish(new SuccessfulPassCutRevision(positionOf(cutter).name()));
//    }
//
...
//        playerStatisticsOf(shooter.definition().id()).addScore(shootInTargetSavedOf(positionOf(shooter)));
//        playerStatisticsOf(goalkeeper.definition().id()).addScore(saves(positionOf(goalkeeper)));
//        VarTerminal.publish(new ShootInTargetRevision(positionOf(shooter).name()));
//    }
//
//    public void addGoal(Player scorer, Player goalkeeper, String rival) {
...
//        playersOf(rival).forEach(p -> playerStatisticsOf(p.definition().id()).addScore(goalReceivedOf(positionOf(p))));
...
//        VarTerminal.publish(new FaultReceivedRevision(positionOf(fouled).name()));
//    }
//
...
//        playerStatisticsOf(fouler.definition().id()).addScore(yellowExpulsionOf(positionOf(fouler)));
