...
//
//public class OldGoalEventSimulator extends EventSimulator {
...
//
//    public OldGoalEventSimulator(MatchState state, PlayerValue playerValue) {
...
//            events.add(new MatchEvent(local(), Match.MatchEvent.Type.Goal, minute, scorer, assist, null));
//        }
//
