...
public class OverallCalculator {
    ...
    public static double overall(ProtrixSkills skills, ProtrixPlayer player, Position position) {
    ...
    public static double techniqueSummary(ProtrixSkills skills, Position position) {
        Double[] factors = Factors.get(position);
        double overall = 0.0;
    ...
    public static double speedSummary(ProtrixSkills skills, Position position) {
        Double[] factors = Factors.get(position);
        double overall = 0.0;
    ...
    public static double physiqueSummary(ProtrixSkills skills, Position position) {
        Double[] factors = Factors.get(position);
        double overall = 0.0;
    ...
    public static double shootSummary(ProtrixSkills skills, Position position) {
    ...
    public static double passSummary(ProtrixSkills skills, Position position) {
        Double[] factors = Factors.get(position);
        double overall = 0.0;
    ...
    public static double dribbleSummary(ProtrixSkills skills, Position position) {
        Double[] factors = Factors.get(position);
        double overall = 0.0;
    ...
    public static double mentalitySummary(ProtrixSkills skills, Position position) {
        Double[] factors = Factors.get(position);
        double overall = 0.0;
    ...
    public static double goalkeeperSummary(ProtrixSkills skills, Position position) {
        Double[] factors = Factors.get(position);
        double overall = 0.0;
