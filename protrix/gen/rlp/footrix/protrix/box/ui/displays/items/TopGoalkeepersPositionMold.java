...
public class TopGoalkeepersPositionMold extends io.intino.alexandria.ui.displays.components.Item<ItemNotifier, rlp.footrix.protrix.model.PlayerRecord, ProtrixBox> {
	...
	public void init() {
		super.init();
		if (topGoalkeepersPosition == null) topGoalkeepersPosition = register(new TopGoalkeepersPosition(box()).<TopGoalkeepersPosition>id("a_1129245879").owner(TopGoalkeepersPositionMold.this));
	}
