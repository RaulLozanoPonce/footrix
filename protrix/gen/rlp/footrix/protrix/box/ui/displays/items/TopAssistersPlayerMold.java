...
public class TopAssistersPlayerMold extends io.intino.alexandria.ui.displays.components.Item<ItemNotifier, rlp.footrix.protrix.model.PlayerRecord, ProtrixBox> {
	...
	public void init() {
		super.init();
		if (topAssistersPlayer == null) topAssistersPlayer = register(new TopAssistersPlayer(box()).<TopAssistersPlayer>id("a_1242879440").owner(TopAssistersPlayerMold.this));
	}
