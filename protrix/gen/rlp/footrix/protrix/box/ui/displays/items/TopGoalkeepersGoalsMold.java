...
public class TopGoalkeepersGoalsMold extends io.intino.alexandria.ui.displays.components.Item<ItemNotifier, rlp.footrix.protrix.model.PlayerRecord, ProtrixBox> {
	...
	public void init() {
		super.init();
		if (topGoalkeepersGoals == null) topGoalkeepersGoals = register(new TopGoalkeepersGoals(box()).<TopGoalkeepersGoals>id("a178684594").owner(TopGoalkeepersGoalsMold.this));
	}
