...
public class TopAssistersPositionMold extends io.intino.alexandria.ui.displays.components.Item<ItemNotifier, rlp.footrix.protrix.model.PlayerRecord, ProtrixBox> {
	...
	public void init() {
		super.init();
		if (topAssistersPosition == null) topAssistersPosition = register(new TopAssistersPosition(box()).<TopAssistersPosition>id("a1279615149").owner(TopAssistersPositionMold.this));
	}
